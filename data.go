...
//coordinates of the outermost quadrant (the universe): the bottom left corner is (0, 0), x increases as we go from left to right; y increases as we go from bottom to top
